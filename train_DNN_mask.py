...
def train(DNN_path, Xtrain, ytrain0, ytrain1, ytrain2, ytrain3, n_hid, n_epochs, batch_size, n_sources, features):    
   ...
   if n_sources == 4:
      o3 = ( Dense(n_freq, activation='sigmoid'))(x)

   if n_sources == 3:
      DNN = Model(input_img, [o0,o1,o2])
   elif n_sources == 4:
      DNN = Model(input_img, [o0,o1,o2,o3])
   ...
   DNN.fit_generator(generator(Xtrain, ytrain0, ytrain1, ytrain2, ytrain3, batch_size, n_sources), samples_per_epoch=n_samples/batch_size, callbacks=[checkpoint], nb_epoch=n_epochs)
